...
if numel(S) == 1
   ...
   % sections of code. 
   % With n = Inf, shrinks objects to points. It removes pixels so
   % that objects without holes shrink to a point, and objects with 
   % holes shrink to a connected ring halfway between each hole and 
   % the outer boundary. This option preserves the Euler number 
   %(also known as the Euler characteristic).
